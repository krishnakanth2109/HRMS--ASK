        ...
        <div className="overflow-x-auto overflow-y-auto flex-1 custom-scrollbar">
            ...
            <tbody className="divide-y divide-slate-100">
                {filteredRequests.map((lv) => {
                    ...
                    <td className="p-5 whitespace-nowrap font-medium text-slate-600">{lv.from}</td>
                    <td className="p-5 whitespace-nowrap font-medium text-slate-600">{lv.to}</td>
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                                            {lv.details.map((d, i) => (
                                                <div key={i} className="border border-slate-200 p-3 rounded-lg text-xs bg-slate-50 hover:bg-white hover:shadow-md transition-all cursor-default">
                                                    <div className="font-bold text-slate-700 mb-1">{d.date}</div>
