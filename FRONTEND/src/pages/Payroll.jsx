        ...
        <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
          ...
          <div className="bg-red-50 p-3 rounded-lg border border-red-100">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2 border-t">
              <div>
                <label className="text-xs font-semibold text-gray-600">PT Slab 1 (Below or Equal to 15k) Amount (₹)</label>
              ...
              <div>
                <label className="text-xs font-semibold text-gray-600">PT Slab 2 (Above or Equal to 20k) Amount (₹)</label>
